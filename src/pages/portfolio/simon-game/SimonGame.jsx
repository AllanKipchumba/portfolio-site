      ...
      <div className="pt-12 max-w-[80%] mx-auto grid grid-cols-1 md:grid-cols-5 gap-1 md:gap-8">
        <div className="md:col-span-4 bg-[#39393F] rounded-3xl p-5 mb-3">
          ...
          <p className="text-[#bdc1c6]">
            ...
            Using vanilla JavaScript, I attempted and succeeded in creating this
            functionality. I learnt how to manipulate the DOM and use JavaScript
            methods, which helped me improve my JavaScript understanding.
          </p>
