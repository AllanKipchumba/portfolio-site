      ...
      {hide && (
        <div className="hide">
          <p>
            ...
            challenged to stretch your thinking and consider all possibilities.
            It is an intriguing STEM field that I would recommend to anyone that
            is immensely interested in Science, Technology, Engineering and
            Mathematics. Every experience I've had in engineering school is
